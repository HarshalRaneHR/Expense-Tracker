...
const Income = () => {
  ...
  const handleAddIcome = async (income) => {
  ...
  const handleDownloadIncomeDetails = async (id) => {
    try {
      ...
      console.error(
        "Error downloading income_details:",
        error?.response?.data?.message || error?.message
      );
    ...
    <DashboardLayout activeMenu="Income">
      <div className="my-5 mx-auto">
        ...
        <Modal
          ...
          title="Add Income"
        >
          <AddIncomeForm onAddIncome={handleAddIcome} />
        </Modal>
        ...
        >
          <DeleteAlert
            ...
            onDelete={() => deleteIcome(openDeleteAlert.data)}
          />
        </Modal>
      </div>
    </DashboardLayout>
